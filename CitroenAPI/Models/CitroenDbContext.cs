...
public class CitroenDbContext : DbContext
{
    ...
    => optionsBuilder.UseSqlServer("Data Source=SQL5053.site4now.net;Initial Catalog=db_a056d0_cyberlink;User Id=db_a056d0_cyberlink_admin;Password=Citroen_api2024");
